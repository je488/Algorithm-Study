...
#반복문의 범위가 0 ~ 1000000인 이유는 N은 0 ~ 500000이지만 전체 채널은 무한대이므로
#ex) N = 500000이고 1, 2, 3, 4, 5번이 고장났을 때 100에서 + 버튼을 499900번 누르는 것보다
#ex) 600000번으로 이동한 뒤 - 버튼을 100000번 누르는 것이 버튼을 더 적게 누르므로 정답
